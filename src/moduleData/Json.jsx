export const data = [
  ...
  { id: "21", name: "Product", parent_id: "9", orderBy: 1, path: "/product/product/articles" },
  { id: "22", name: "Draft", parent_id: "9", orderBy: 2, path: "/product/product/draft" },
  { id: "23", name: "Packaging", parent_id: "9", orderBy: 3, path: "/product/product/package" },
  { id: "24", name: "Upload", parent_id: "9", orderBy: 4, path: "/product/product/upload" },

  { id: "25", name: "PIM", parent_id: "10", orderBy: 1, path: "/product/pim" },
  { id: "26", name: "Map Channel", parent_id: "10", orderBy: 3, path: "/product/pim/map-channel" },
  { id: "27", name: "Enrich Product", parent_id: "10", orderBy: 4, path: "/product/pim/enrich-product" },
  ...
  { id: "40", name: "Order Management", parent_id: "34", orderBy: 1, path: "/sales/order-management" },
  { id: "41", name: "Open Order", parent_id: "34", orderBy: 2, path: "/sales/open-order" },
  ...
  { id: "47", name: "Sales Order", parent_id: "35", orderBy: 1, path: "/sales/sales-order" },

  { id: "48", name: "Invoice", parent_id: "36", orderBy: 1, path: "/sales/invoice" },

  { id: "49", name: "Shipment Note", parent_id: "37", orderBy: 1, path: "/sales/shippment-note" },

  { id: "50", name: "Return Note", parent_id: "38", orderBy: 1, path: "/sales/return-note" },

  { id: "51", name: "Packing", parent_id: "39", orderBy: 1, path: "/sales/packing" },
  ...
  { id: "63", name: "Sales Man", parent_id: "5", orderBy: 3, path: "/crm/salesman" },
  ...
  { id: "69", name: "Sales Man", parent_id: "63", orderBy: 1, path: "/crm/salesman" },
  ...
  { id: "85", name: "Company Profile", parent_id: "80", orderBy: 1, path: '/settings/company-profile' },
  { id: "86", name: "Channels", parent_id: "80", orderBy: 2, path: '/settings/company-profile/channels' },
  { id: "87", name: "Other Settings", parent_id: "80", orderBy: 3, path: '/settings/company-profile/other-settings' },
  { id: "88", name: "Legal", parent_id: "80", orderBy: 4,path: '/settings/company-profile/legal' },
  { id: "89", name: "Business Rules", parent_id: "80", orderBy: 5, path: '/settings/company-profile/business-rules' },

  { id: "90", name: "Location Details", parent_id: "81", orderBy: 1, path: "/settings/location" },
  { id: "91", name: "Bulk Upload", parent_id: "81", orderBy: 3, modal: true },

  { id: "92", name: "Payment Mode", parent_id: "82", orderBy: 1, path: "/settings/payment" },

  { id: "93", name: "Shipment Mode", parent_id: "83", orderBy: 1, path: "/settings/shipment" },

  { id: "94", name: "User Management", parent_id: "84", orderBy: 1, path: "/settings/user-management" },
  { id: "95", name: "Role", parent_id: "84", orderBy: 2, path: "/settings/user/role" },
  { id: "96", name: "Role Privileges", parent_id: "84", orderBy: 3, path: "/settings/user/role-privileges" },
  { id: "97", name: "Users", parent_id: "84", orderBy: 4, path: "/settings/user" },
];
