...
const ProductPrice = () => {
	...
	useEffect(() => {
		if (markUpData.isMarkUp) {
			...
			// Clear fields when markUp is unchecked
			setMarkUpData({
				costPrice: 0,
				markUpPercent: 0,
				sellingPrice: 0,
	...
	}, [markUpData.isMarkUp, markUpData.costPrice, markUpData.markUpPercent]);
	...
	useEffect(() => {
		if (markDownData.isMarkDown) {
			...
			// Clear fields when markDown is unchecked
			setMarkDownData({
				mrp: 0,
				markDownPercent: 0,
				costPrice: 0,
	...
	}, [markDownData.isMarkDown, markDownData.mrp, markDownData.markDownPercent]);
	...
	const handleCheckboxChange = (type) => {
		if (type === 'markUp') {
			...
			setProduct(prev => ({
				...
				priceSetting: {
					...prev.priceSetting,
					isMarkUp: !prev.priceSetting.isMarkUp,
					isMarkDown: false,
					costPrice: 0,
					markUpPercent: 0,
					sellingPrice: 0,
			...
			setProduct(prev => ({
				...
				priceSetting: {
					...prev.priceSetting,
					isMarkDown: !prev.priceSetting.isMarkDown,
					isMarkUp: false,
					costPrice: 0,
					markDownPercent: 0,
					sellingPrice: 0,
