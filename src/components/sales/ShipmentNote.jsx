...
const ShipmentNote = () => {
  const stnNo = "1";
  const stnDate = "04/10/2024";
  const selectPackingId = "002";
  ...
  return (
    <div style={{ padding: '20px' }}>
      <Grid style={{ marginBottom: '30px', fontSize: '16px' }} >
        <Grid.Col span={3}>
          <p><strong>STN No:</strong> {stnNo}</p>
        </Grid.Col>
        <Grid.Col span={3}>
          <p><strong>STN Date:</strong> {stnDate}</p>
        </Grid.Col>
        <Grid.Col span={3}>
          <p><strong>Select Packing Id:</strong> {selectPackingId}</p>
        </Grid.Col>
        <Grid.Col span={3}>
      ...
      <Grid>
        ...
        <Grid.Col span={6}>
          <Grid>
            ...
            <Grid.Col span={6}>
              <TextInput label="Shipment Date" type="date" />
            </Grid.Col>
            <Grid.Col span={6}>
        ...
        <Grid.Col span={6}>
          <div style={{ border: '1px solid #ccc', padding: '20px', borderRadius: '8px' }}>
            <div style={{ textAlign: 'center' }}>
              <h2 style={{ border: '1px solid #ccc' }}>Shipment Note #:001</h2>
              ...
              <p style={{ textAlign: 'start', fontWeight: '600' }}>
                ...
                <span style={{ marginRight: '20px' }}>Packing ID: #002</span>
